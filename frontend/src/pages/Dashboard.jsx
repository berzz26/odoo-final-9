  ...
  return (
    <div className="bg-[#FCEFCB] min-h-screen w-screen text-[#EAECEE] font-sans">
      ...
      <div className="p-4 md:p-8 space-y-8 container mx-auto">
        ...
        {/* --- Banner Section --- */}
        <div className="bg-[#FAD59A] border-2 border-[#4A4E5A] rounded-lg h-56 md:h-64 flex flex-col items-center justify-center text-center">
          <h2 className="text-3xl md:text-4xl text-black" style={{ fontFamily: '"Caveat", cursive' }}>
            Plan Your Next Adventure
          </h2>
          <p className="text-black">Your journey begins here.</p>
        </div>
