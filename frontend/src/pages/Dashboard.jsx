...
const scenicPhotos = [
  'https://images.unsplash.com/photo-1501785888041-af3ef285b470?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w1MjMyNzR8MHwxfHNlYXJjaHwxfHx0cmF2ZWx8ZW58MHx8fHwxNjk5OTg1MjY2fDA&ixlib=rb-4.0.3&q=80&w=1080',
  'https://images.unsplash.com/photo-1498804103061-ad75429c175c?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w1MjMyNzR8MHwxfHNlYXJjaHwxfHxhZHZlbnR1cmV8ZW58MHx8fHwxNjk5OTg1MjY4fDA&ixlib=rb-4.0.3&q=80&w=1080',
  'https://images.unsplash.com/photo-1506197603052-3be9eaef444b?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w1MjMyNzR8MHwxfHNlYXJjaHwxfHxwYXJpc3xlbnwwfHx8fDE2OTk5ODUyNzJ8MA&ixlib=rb-4.0.3&q=80&w=1080',
  'https://images.unsplash.com/photo-1549241520-415d868910b0?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w1MjMyNzR8MHwxfHNlYXJjaHwxfHxyb21lfGVufDB8fHx8MTY5OTk4NTI3MHww&ixlib=rb-4.0.3&q=80&w=1080',
  'https://images.unsplash.com/photo-1518684079-3c35f29910d6?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w1MjMyNzR8MHwxfHNlYXJjaHwxfHxiaGVyY2h8ZW58MHx8fHwxNjk5OTg1MjcwfDA&ixlib=rb-4.0.3&q=80&w=1080'
];
    ...
    const checkAuth = async () => {
      ...
      if (token) {
        ...
        try {
          ...
          if (response.ok) {
            // Token is valid, proceed to fetch trips
            setIsAuth(true);
