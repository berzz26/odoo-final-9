...
return (
  <div className="flex flex-col items-center w-screen min-h-screen bg-white p-4 sm:p-6 gap-6 font-sans">
    <Card className="w-full max-w-6xl shadow-lg bg-[#FCEFCB] border border-[#FAD59A] text-[#A86523]">
          ...
          <div className="flex-shrink-0 text-center">
            <Label htmlFor="avatar-upload" className="cursor-pointer">
              <Avatar className="h-40 w-40 sm:h-48 sm:w-48 border-2 border-[#A86523]">
                ...
                <AvatarFallback className="text-4xl bg-white text-[#A86523]">
          ...
          <div className="w-full">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="space-y-2">
                ...
                <Input id="name" value={name} onChange={(e) => setName(e.target.value)} className="w-full bg-white border border-[#A86523]/50 focus:border-[#A86523] text-[#A86523]" />
              </div>
              <div className="space-y-2">
                <Label htmlFor="email" className="text-base font-semibold">Email</Label>
                <Input id="email" value={email} onChange={(e) => setEmail(e.target.value)} className="w-full bg-white border border-[#A86523]/50 focus:border-[#A86523] text-[#A86523]" />
              </div>
              <div className="space-y-2">
                <Label htmlFor="country" className="text-base font-semibold">Country</Label>
                <Input id="country" value={country} onChange={(e) => setCountry(e.target.value)} className="w-full bg-white border border-[#A86523]/50 focus:border-[#A86523] text-[#A86523]" />
              </div>
              <div className="space-y-2">
                <Label htmlFor="city" className="text-base font-semibold">City</Label>
                <Input id="city" value={city} onChange={(e) => setCity(e.target.value)} className="w-full bg-white border border-[#A86523]/50 focus:border-[#A86523] text-[#A86523]" />
              </div>
            </div>
          </div>
        </div>
      ...
      <CardFooter className="flex justify-end gap-3 p-6">
        <Button className="bg-[#A86523] text-white hover:bg-[#A86523]/90" onClick={handleUpdateProfile}>Save Profile</Button>
        <Button className="bg-red-600 text-white hover:bg-red-600/90" onClick={handleLogout}>Logout</Button>
      </CardFooter>
    </Card>

    <Card className="w-full max-w-6xl shadow-lg text-center bg-[#FCEFCB] border border-[#A86523] text-[#A86523]">
      <CardHeader>
